...
class EventRegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_registration" do
    assert_difference('EventRegistration.count') do
      post event_registrations_url, params: { event_registration: { event_id: @event_registration.event_id, reason: @event_registration.reason, user_id: @event_registration.user_id } }
    end
  ...
  test "should update event_registration" do
    patch event_registration_url(@event_registration), params: { event_registration: { event_id: @event_registration.event_id, reason: @event_registration.reason, user_id: @event_registration.user_id } }
